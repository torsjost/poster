...
\documentclass[xelatex,final,hyperref={pdfpagelabels=true,setpagesize=false,colorlinks=false},xcolor={usenames,dvipsnames,svgnames},notheorems]{beamer}
...
%
\usepackage{amsmath,amsthm,latexsym,pifont}
...
\renewcommand{\authorFig}{\includegraphics[width=\linewidth]{theme/figs/LHK_BW.jpg}}
\renewcommand{\universityLogo}{\includegraphics[width=.8\linewidth]{theme/figs/LundUniversity_C2line_CMYK.png}}
\renewcommand{\footerLeft}{\texttt{liney@matfys.lth.se}}
\renewcommand{\footerRight}{\includegraphics[width=6cm]{theme/figs/nm-logo.pdf}}
